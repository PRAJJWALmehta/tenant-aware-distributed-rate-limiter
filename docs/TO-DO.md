...
- [ ] Add functionality to automatically switch off IP-fallback (disable `ratelimiter.fallback.ip.enabled`) if the application experiences severe CPU throttling, high latency, or symptoms of a DDoS attack.
